...
class QuestionIterationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_iteration" do
    assert_difference('QuestionIteration.count') do
      post question_iterations_url, params: { question_iteration: { content: @question_iteration.content, diplomatic_effect: @question_iteration.diplomatic_effect, economic_effect: @question_iteration.economic_effect, government_effect: @question_iteration.government_effect, question_id: @question_iteration.question_id, societal_effect: @question_iteration.societal_effect, version: @question_iteration.version } }, as: :json
    end
  ...
  test "should update question_iteration" do
    patch question_iteration_url(@question_iteration), params: { question_iteration: { content: @question_iteration.content, diplomatic_effect: @question_iteration.diplomatic_effect, economic_effect: @question_iteration.economic_effect, government_effect: @question_iteration.government_effect, question_id: @question_iteration.question_id, societal_effect: @question_iteration.societal_effect, version: @question_iteration.version } }, as: :json
    assert_response 200
  end
